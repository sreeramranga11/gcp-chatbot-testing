...
bucket = [
  ...
  {
    name                        = "ca-gcs-bucket-9021"
    project_id                  = "prj-gcp-ca-9021"
    environment                 = "ca"
    location                    = "us-west1"
    storage_class               = "STANDARD"
    public_access_prevention    = "enforced"
    ...
    encryption = {
      default_kms_key_name = "projects/prj-gcp-ca-9021/locations/global/keyRings/ca-kr/cryptoKeys/ca-key"
    }
    iam_bindings = [
      {
        role   = "roles/storage.admin"
        member = "group:ca-admins@example.com"
      }
    ]
  },
    {
    name                        = "tx-gcs-bucket-4242"
    project_id                  = "prj-gcp-tx-4242"
    environment                 = "tx"
    location                    = "us-east1"
    storage_class               = "STANDARD"
    public_access_prevention    = "enforced"
    ...
    encryption = {
      default_kms_key_name = "projects/prj-gcp-tx-4242/locations/global/keyRings/tx-kr/cryptoKeys/tx-key"
    }
    iam_bindings = [
      {
        role   = "roles/storage.admin"
        member = "group:tx-admins@example.com"
      }
    ]
  },
  {
    name                        = "ny-gcs-bucket-7878"
    project_id                  = "prj-gcp-ny-7878"
    environment                 = "ny"
    location                    = "us-east4"
    storage_class               = "STANDARD"
    public_access_prevention    = "enforced"
    ...
    encryption = {
      default_kms_key_name = "projects/prj-gcp-ny-7878/locations/global/keyRings/ny-kr/cryptoKeys/ny-key"
    }
    iam_bindings = [
      {
        role   = "roles/storage.admin"
        member = "group:ny-admins@example.com"
      }
    ]
  }
]
