    ...
    iam_bindings = [
      {
        ...
        member = "user:shaggy@example.com"
      }
    ]
  },
  {
    ...
    iam_bindings = [
      {
        ...
        member = "group:fred-admins@example.com"
      }
    ]
  },
    {
    name                        = "velma-gcs-bucket-1234"
    project_id                  = "prj-gcp-dev-1111"
    environment                 = "velma"
    location                    = "us-central1"
    storage_class               = "STANDARD"
    ...
    iam_bindings = [
      {
        role   = "roles/storage.objectViewer"
        member = "user:velma@example.com"
      }
    ]
  },
  {
    name                        = "scooby-gcs-bucket-1480"
    project_id                  = "prj-gcp-prod-1234"
    environment                 = "scooby"
    location                    = "us-central1"
    storage_class               = "STANDARD"
    ...
    iam_bindings = [
      {
        role   = "roles/storage.admin"
        member = "group:scooby-admins@example.com"
      }
    ]
  },
    {
    name                        = "daphne-gcs-bucket-1234"
    project_id                  = "prj-gcp-dev-1111"
    environment                 = "daphne"
    location                    = "us-central1"
    storage_class               = "STANDARD"
    ...
    iam_bindings = [
      {
        role   = "roles/storage.objectViewer"
        member = "user:daphne@example.com"
      }
    ]
  }
]
