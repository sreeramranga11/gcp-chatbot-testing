...
bucket = [
  ...
  {
    name                        = "staging-gcs-bucket-1628"
    project_id                  = "prj-gcp-staging-2222"
    environment                 = "staging"
    location                    = "us-central1"
    storage_class               = "STANDARD"
    public_access_prevention    = "enforced"
    ...
    encryption = {
      default_kms_key_name = "projects/prj-gcp-staging-2222/locations/global/keyRings/staging-kr/cryptoKeys/staging-key"
    }
    iam_bindings = [
      {
        role   = "roles/storage.objectViewer"
        member = "user:staging-reader@example.com"
      },
      {
        role   = "roles/storage.objectAdmin"
        member = "group:staging-admins@example.com"
      }
    ]
  }
]
