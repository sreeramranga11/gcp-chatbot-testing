...
bucket = [
  ...
  {
    name                        = "dev-integration-bucket-9876"
    project_id                  = "prj-gcp-dev-1111"
    environment                 = "dev"
    location                    = "us-central1"
    storage_class               = "STANDARD"
    ...
    logging = {
      log_bucket        = "dev-logging-bucket"
      log_object_prefix = "logs/dev-integration-bucket-9876/"
    }
    encryption = {
      default_kms_key_name = "projects/prj-gcp-dev-1111/locations/global/keyRings/dev-kr/cryptoKeys/dev-key"
    }
    iam_bindings = [
      {
        ...
        member = "serviceAccount:integration-svc@prj-gcp-dev-1111.iam.gserviceaccount.com"
      }
    ]
  }
]
